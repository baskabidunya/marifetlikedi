  ...
  return (
    <section className="py-section-gap px-container-padding-mobile md:px-container-padding-desktop max-w-7xl mx-auto">
      ...
      <div className="flex justify-center mb-12 overflow-x-auto no-scrollbar">
        <div className="inline-flex p-1 bg-surface-bright/20 backdrop-blur-md rounded-full border border-white/10 shrink-0">
          <button className="px-5 sm:px-8 py-2 rounded-full font-label-md text-on-primary bg-gradient-to-r from-primary to-primary-container shadow-lg transition-all duration-300 cursor-pointer whitespace-nowrap">
            Haftalık
          </button>
          <button className="px-5 sm:px-8 py-2 rounded-full font-label-md text-on-surface-variant hover:text-on-surface hover:bg-white/5 transition-all duration-300 cursor-pointer whitespace-nowrap">
            Aylık
          </button>
          <button className="px-5 sm:px-8 py-2 rounded-full font-label-md text-on-surface-variant hover:text-on-surface hover:bg-white/5 transition-all duration-300 cursor-pointer whitespace-nowrap">
            Yıllık
